...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.dev.platform.pagopa.it/checkout/ec/v1';
    ...
    {
        $report  = 'PHP SDK (PagoPA\CheckoutEc) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.dev.platform.pagopa.it/checkout/ec/v1",
