...
class InfoApi
{
     ...
     * @return \GovPay\Backoffice\Model\InfoGovPay|\GovPay\Backoffice\Model\FaultBean
     */
     ...
     * @throws \GovPay\Backoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \GovPay\Backoffice\Model\InfoGovPay|\GovPay\Backoffice\Model\FaultBean, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\GovPay\Backoffice\Model\InfoGovPay',
                        $request,
                        $response,
                    );
                case 500:
    ...
    {
        $returnType = '\GovPay\Backoffice\Model\InfoGovPay';
        $request = $this->getInfoRequest($contentType);
