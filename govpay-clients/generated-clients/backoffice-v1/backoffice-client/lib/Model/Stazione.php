 ...
 */
class Stazione implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stazione';
    ...
    protected static $openAPITypes = [
        'password' => 'string',
        'abilitato' => 'bool',
        'versione' => '\GovPay\Backoffice\Model\VersioneStazione',
        'id_stazione' => 'string',
        'domini' => '\GovPay\Backoffice\Model\DominioIndex[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id_stazione'] === null) {
            $invalidProperties[] = "'id_stazione' can't be null";
        }
     ...
     * Sets password
     *
     * @param string|null $password Password per la stazione, non necessaria nel modello unico. Resta obbligatoria per la versione = V1.
     *
     * @return self
     */
     ...
     * Gets versione
     *
     * @return \GovPay\Backoffice\Model\VersioneStazione
     */
     ...
     * Sets versione
     *
     * @param \GovPay\Backoffice\Model\VersioneStazione $versione versione
     *
     * @return self
     */
     ...
     * Sets id_stazione
     *
     * @param string $id_stazione Identificativo della stazione
     *
     * @return self
     */
     ...
     * Sets domini
     *
     * @param \GovPay\Backoffice\Model\DominioIndex[] $domini domini
     *
     * @return self
     */
