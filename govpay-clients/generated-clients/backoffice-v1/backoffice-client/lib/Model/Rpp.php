 ...
 */
class Rpp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rpp';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bloccante', $data ?? [], true);
    ...
    */
     ...
     * @return bool|null
     */
    public function getBloccante()
    {
        return $this->container['bloccante'];
    }

    /**
     * Sets bloccante
     *
     * @param bool|null $bloccante Indica se la richiesta di pagamento deve essere bloccata quando viene inviata mentre e' ancora in corso il tentativo precedente
     *
     * @return self
     */
    public function setBloccante($bloccante)
    {
        if (is_null($bloccante)) {
            throw new \InvalidArgumentException('non-nullable bloccante cannot be null');
        }
        $this->container['bloccante'] = $bloccante;
