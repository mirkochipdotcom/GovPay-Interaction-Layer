...
/**
 * EsitoOperazione Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class EsitoOperazione implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'esitoOperazione';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['percentuale'] === null) {
            $invalidProperties[] = "'percentuale' can't be null";
        }
     ...
     * Sets percentuale
     *
     * @param float $percentuale Percentuale di avanzamento
     *
     * @return self
     */
    public function setPercentuale($percentuale)
    {
        if (is_null($percentuale)) {
            throw new \InvalidArgumentException('non-nullable percentuale cannot be null');
        }
     ...
     * Sets descrizione
     *
     * @param string $descrizione testo descrittivo
     *
     * @return self
     */
     ...
     * Sets stato
     *
     * @param string|null $stato stato dell'operazione (OK/KO/WARN)
     *
     * @return self
     */
