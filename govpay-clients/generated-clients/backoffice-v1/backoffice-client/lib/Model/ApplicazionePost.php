...
/**
 * ApplicazionePost Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class ApplicazionePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'applicazionePost';
    ...
    protected static $openAPITypes = [
        ...
        'domini' => '\GovPay\Backoffice\Model\ApplicazionePostDominiInner[]',
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((!preg_match("/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?!.*[\\s]).{8,}$/", ObjectSerializer::toString($password)))) {
            throw new \InvalidArgumentException("invalid value for \$password when calling ApplicazionePost., must conform to the pattern /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?!.*[\\s]).{8,}$/.");
        }
     ...
     * Gets domini
     *
     * @return \GovPay\Backoffice\Model\ApplicazionePostDominiInner[]|null
     */
     ...
     * Sets domini
     *
     * @param \GovPay\Backoffice\Model\ApplicazionePostDominiInner[]|null $domini domini su cui e' abilitato ad operare
     *
     * @return self
     */
     ...
     * Sets tipi_pendenza
     *
     * @param string[]|null $tipi_pendenza tipologie di pendenza su cui e' abilitato ad operare
     *
     * @return self
     */
     ...
     * Sets ruoli
     *
     * @param string[]|null $ruoli lista dei ruoli attivi sull'applicazione
     *
     * @return self
     */
