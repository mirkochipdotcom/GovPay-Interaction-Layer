...
class Dominio implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id_dominio' => 'string',
        'unita_operative' => '\GovPay\Backoffice\Model\UnitaOperativa[]',
        'conti_accredito' => '\GovPay\Backoffice\Model\ContiAccredito[]',
        'entrate' => '\GovPay\Backoffice\Model\Entrata[]',
        'tipi_pendenza' => '\GovPay\Backoffice\Model\TipoPendenzaDominio[]'
    ];
    ...
    */
    ...
    public function setIuvPrefix($iuv_prefix)
    {
        ...
        if ((!preg_match("/(\\d*(%\\([yYa{t|p}]\\))?)+/", ObjectSerializer::toString($iuv_prefix)))) {
            throw new \InvalidArgumentException("invalid value for \$iuv_prefix when calling Dominio., must conform to the pattern /(\\d*(%\\([yYa{t|p}]\\))?)+/.");
        }
     ...
     *
     * @param \GovPay\Backoffice\Model\UnitaOperativa[]|null $unita_operative unita_operative
     *
     * @return self
     */
     ...
     *
     * @return \GovPay\Backoffice\Model\ContiAccredito[]|null
     */
     ...
     *
     * @param \GovPay\Backoffice\Model\ContiAccredito[]|null $conti_accredito conti_accredito
     *
     * @return self
     */
     ...
     * Gets entrate
     *
     * @return \GovPay\Backoffice\Model\Entrata[]|null
     */
     ...
     * Sets entrate
     *
     * @param \GovPay\Backoffice\Model\Entrata[]|null $entrate entrate
     *
     * @return self
     */
     ...
     * Gets tipi_pendenza
     *
     * @return \GovPay\Backoffice\Model\TipoPendenzaDominio[]|null
     */
     ...
     * Sets tipi_pendenza
     *
     * @param \GovPay\Backoffice\Model\TipoPendenzaDominio[]|null $tipi_pendenza tipi_pendenza
     *
     * @return self
     */
