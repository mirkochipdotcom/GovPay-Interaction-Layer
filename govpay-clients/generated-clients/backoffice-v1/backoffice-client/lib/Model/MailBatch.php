 ...
 */
class MailBatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mailBatch';
    ...
    protected static $openAPITypes = [
        'abilitato' => 'bool',
        'mailserver' => '\GovPay\Backoffice\Model\Mailserver'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mailserver', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mailserver'] === null) {
            $invalidProperties[] = "'mailserver' can't be null";
        }
     ...
     * Gets mailserver
     *
     * @return \GovPay\Backoffice\Model\Mailserver
     */
     ...
     * Sets mailserver
     *
     * @param \GovPay\Backoffice\Model\Mailserver $mailserver mailserver
     *
     * @return self
     */
    public function setMailserver($mailserver)
    {
        if (is_null($mailserver)) {
            throw new \InvalidArgumentException('non-nullable mailserver cannot be null');
        }
