...
/**
 * OperazionePendenzaRichiesta Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class OperazionePendenzaRichiesta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'operazionePendenza_richiesta';
    ...
    protected static $setters = [
        ...
        'motivo_annullamento' => 'setMotivoAnnullamento'
    ];
    ...
    protected static $getters = [
        ...
        'motivo_annullamento' => 'getMotivoAnnullamento'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('motivo_annullamento', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['motivo_annullamento'] === null) {
            $invalidProperties[] = "'motivo_annullamento' can't be null";
        }
    ...
    public function setIdTipoPendenza($id_tipo_pendenza)
    {
        ...
        if ((!preg_match("/(^[a-zA-Z0-9\\-_\\.]{1,35}$)/", ObjectSerializer::toString($id_tipo_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_tipo_pendenza when calling OperazionePendenzaRichiesta., must conform to the pattern /(^[a-zA-Z0-9\\-_\\.]{1,35}$)/.");
        }
    ...
    public function setVoci($voci)
    {
        ...
        if ((count($voci) > 5)) {
            throw new \InvalidArgumentException('invalid value for $voci when calling OperazionePendenzaRichiesta., number of items must be less than or equal to 5.');
        }
        if ((count($voci) < 1)) {
            throw new \InvalidArgumentException('invalid length for $voci when calling OperazionePendenzaRichiesta., number of items must be greater than or equal to 1.');
        }
    ...
    /**
     * Gets motivo_annullamento
     *
     * @return string
     */
    public function getMotivoAnnullamento()
    {
        return $this->container['motivo_annullamento'];
    }

    /**
     * Sets motivo_annullamento
     *
     * @param string $motivo_annullamento Descrizione dell'operazione
     *
     * @return self
     */
    public function setMotivoAnnullamento($motivo_annullamento)
    {
        if (is_null($motivo_annullamento)) {
            throw new \InvalidArgumentException('non-nullable motivo_annullamento cannot be null');
        }
        $this->container['motivo_annullamento'] = $motivo_annullamento;
