...
/**
 * VocePendenzaRiscossione Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class VocePendenzaRiscossione implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vocePendenzaRiscossione';
    ...
    */
    ...
    public function setDescrizioneCausaleRpt($descrizione_causale_rpt)
    {
        ...
        if ((mb_strlen($descrizione_causale_rpt) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descrizione_causale_rpt when calling VocePendenzaRiscossione., must be smaller than or equal to 140.');
        }
    ...
    public function setCodEntrata($cod_entrata)
    {
        ...
        if ((!preg_match("/(^[a-zA-Z0-9\\-_\\.]{1,35}$)/", ObjectSerializer::toString($cod_entrata)))) {
            throw new \InvalidArgumentException("invalid value for \$cod_entrata when calling VocePendenzaRiscossione., must conform to the pattern /(^[a-zA-Z0-9\\-_\\.]{1,35}$)/.");
        }
