...
/**
 * ConnettoreNotificaPagamentiGovPay Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class ConnettoreNotificaPagamentiGovPay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connettoreNotificaPagamentiGovPay';
    ...
    public const TIPO_CONNETTORE_REST = 'REST';
    public const VERSIONE_API_REST_V1 = 'REST v1';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('versione_zip', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getVersioneZip()
    {
        return $this->container['versione_zip'];
    }

    /**
     * Sets versione_zip
     *
     * @param string|null $versione_zip Versione del file zip prodotto.
     *
     * @return self
     */
    public function setVersioneZip($versione_zip)
    {
        if (is_null($versione_zip)) {
            throw new \InvalidArgumentException('non-nullable versione_zip cannot be null');
        }
        $this->container['versione_zip'] = $versione_zip;
