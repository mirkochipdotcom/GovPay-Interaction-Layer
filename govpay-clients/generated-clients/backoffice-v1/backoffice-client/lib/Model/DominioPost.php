 ...
 */
class DominioPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dominioPost';
    ...
    */
    ...
    public function setIuvPrefix($iuv_prefix)
    {
        ...
        if ((!preg_match("/(\\d*(%\\([yYa{t|p}]\\))?)+/", ObjectSerializer::toString($iuv_prefix)))) {
            throw new \InvalidArgumentException("invalid value for \$iuv_prefix when calling DominioPost., must conform to the pattern /(\\d*(%\\([yYa{t|p}]\\))?)+/.");
        }
