<?php
/**
 * TipoAutenticazioneOauth2ClientCredentials
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * TipoAutenticazioneOauth2ClientCredentials Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class TipoAutenticazioneOauth2ClientCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tipoAutenticazioneOauth2ClientCredentials';
    ...
    */
    ...
    public function setClientId($client_id)
    {
        ...
        if ((mb_strlen($client_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $client_id when calling TipoAutenticazioneOauth2ClientCredentials., must be smaller than or equal to 255.');
        }
    ...
    public function setClientSecret($client_secret)
    {
        ...
        if ((mb_strlen($client_secret) > 255)) {
            throw new \InvalidArgumentException('invalid length for $client_secret when calling TipoAutenticazioneOauth2ClientCredentials., must be smaller than or equal to 255.');
        }
    ...
    public function setUrlTokenEndpoint($url_token_endpoint)
    {
        ...
        if ((mb_strlen($url_token_endpoint) > 255)) {
            throw new \InvalidArgumentException('invalid length for $url_token_endpoint when calling TipoAutenticazioneOauth2ClientCredentials., must be smaller than or equal to 255.');
        }
    ...
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) > 255)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling TipoAutenticazioneOauth2ClientCredentials., must be smaller than or equal to 255.');
        }
