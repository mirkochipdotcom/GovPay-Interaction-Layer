...
/**
 * TipoAutenticazioneHeader Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class TipoAutenticazioneHeader implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tipoAutenticazioneHeader';
    ...
    */
    ...
    public function setHeaderName($header_name)
    {
        ...
        if ((mb_strlen($header_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $header_name when calling TipoAutenticazioneHeader., must be smaller than or equal to 255.');
        }
    ...
    public function setHeaderValue($header_value)
    {
        ...
        if ((mb_strlen($header_value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $header_value when calling TipoAutenticazioneHeader., must be smaller than or equal to 255.');
        }
