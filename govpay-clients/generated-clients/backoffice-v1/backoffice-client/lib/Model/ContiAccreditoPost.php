...
/**
 * ContiAccreditoPost Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class ContiAccreditoPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contiAccreditoPost';
    ...
    */
    ...
    public function setDescrizione($descrizione)
    {
        ...
        if ((!preg_match("/^.{1,255}$/", ObjectSerializer::toString($descrizione)))) {
            throw new \InvalidArgumentException("invalid value for \$descrizione when calling ContiAccreditoPost., must conform to the pattern /^.{1,255}$/.");
        }
    ...
    public function setIntestatario($intestatario)
    {
        ...
        if ((!preg_match("/^.{1,255}$/", ObjectSerializer::toString($intestatario)))) {
            throw new \InvalidArgumentException("invalid value for \$intestatario when calling ContiAccreditoPost., must conform to the pattern /^.{1,255}$/.");
        }
