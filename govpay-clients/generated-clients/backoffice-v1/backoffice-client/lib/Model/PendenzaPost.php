...
/**
 * PendenzaPost Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class PendenzaPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pendenzaPost';
    ...
    */
    ...
    public function setIdTipoPendenza($id_tipo_pendenza)
    {
        ...
        if ((!preg_match("/(^[a-zA-Z0-9\\-_\\.]{1,35}$)/", ObjectSerializer::toString($id_tipo_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_tipo_pendenza when calling PendenzaPost., must conform to the pattern /(^[a-zA-Z0-9\\-_\\.]{1,35}$)/.");
        }
    ...
    public function setVoci($voci)
    {
        ...
        if ((count($voci) > 5)) {
            throw new \InvalidArgumentException('invalid value for $voci when calling PendenzaPost., number of items must be less than or equal to 5.');
        }
        if ((count($voci) < 1)) {
            throw new \InvalidArgumentException('invalid length for $voci when calling PendenzaPost., number of items must be greater than or equal to 1.');
        }
