...
/**
 * VocePendenzaRendicontazione Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Backoffice
 * @author   OpenAPI Generator team
 ...
 */
class VocePendenzaRendicontazione implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vocePendenzaRendicontazione';
    ...
    protected static $openAPITypes = [
        ...
        'pendenza' => '\GovPay\Backoffice\Model\PendenzaIndex',
        'cod_entrata' => 'string',
    ...
    */
    ...
    public function setDescrizioneCausaleRpt($descrizione_causale_rpt)
    {
        ...
        if ((mb_strlen($descrizione_causale_rpt) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descrizione_causale_rpt when calling VocePendenzaRendicontazione., must be smaller than or equal to 140.');
        }
     ...
     * Gets pendenza
     *
     * @return \GovPay\Backoffice\Model\PendenzaIndex|null
     */
     ...
     * Sets pendenza
     *
     * @param \GovPay\Backoffice\Model\PendenzaIndex|null $pendenza pendenza
     *
     * @return self
     */
    ...
    public function setCodEntrata($cod_entrata)
    {
        ...
        if ((!preg_match("/(^[a-zA-Z0-9\\-_\\.]{1,35}$)/", ObjectSerializer::toString($cod_entrata)))) {
            throw new \InvalidArgumentException("invalid value for \$cod_entrata when calling VocePendenzaRendicontazione., must conform to the pattern /(^[a-zA-Z0-9\\-_\\.]{1,35}$)/.");
        }
