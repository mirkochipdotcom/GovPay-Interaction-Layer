 ...
 */
class RicevutaRt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ricevuta_rt';
    ...
    public const TIPO_CT_RICEVUTA_TELEMATICA = 'ctRicevutaTelematica';
    public const TIPO_CT_RECEIPT = 'ctReceipt';
    ...
    {
        return [
            self::TIPO_CT_RICEVUTA_TELEMATICA,
            self::TIPO_CT_RECEIPT,
        ];
    }
    ...
    */
     ...
     * Sets tipo
     *
     * @param string|null $tipo Tipo XML della ricevuta
     *
     * @return self
     */
     ...
     * Sets xml
     *
     * @param string|null $xml ricevuta in formato XML originale codificata in base64
     *
     * @return self
     */
     ...
     * Sets json
     *
     * @param object|null $json ricevuta in formato JSON
     *
     * @return self
     */
