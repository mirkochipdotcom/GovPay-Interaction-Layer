...
class TipoPendenza implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^([\\w\\-\\.]){1,35}$/", $this->container['id_tipo_pendenza'])) {
     ...
     *
     * @param string $id_tipo_pendenza Identificativo della pendenza nel gestionale proprietario
     *
     * @return self
     */
    public function setIdTipoPendenza($id_tipo_pendenza)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_tipo_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_tipo_pendenza when calling TipoPendenza., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
