...
/**
 * PendenzaArchivio Class Doc Comment
 *
 * @category Class
 ...
 */
class PendenzaArchivio implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PendenzaArchivio';
    ...
    protected static $openAPITypes = [
        ...
        'stato' => '\GovPay\Pagamenti\Model\StatoPendenza',
    ...
    */
    ...
    public function setIdA2A($id_a2_a)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_a2_a)))) {
            throw new \InvalidArgumentException("invalid value for \$id_a2_a when calling PendenzaArchivio., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
    ...
    public function setIdPendenza($id_pendenza)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_pendenza when calling PendenzaArchivio., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
    ...
    public function setIdTipoPendenza($id_tipo_pendenza)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_tipo_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_tipo_pendenza when calling PendenzaArchivio., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
    ...
    public function setCausale($causale)
    {
        ...
        if ((mb_strlen($causale) > 140)) {
            throw new \InvalidArgumentException('invalid length for $causale when calling PendenzaArchivio., must be smaller than or equal to 140.');
        }
    ...
    public function setImporto($importo)
    {
        ...
        if (($importo > 10000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $importo when calling PendenzaArchivio., must be smaller than or equal to 10000000000000000.');
        }
        if (($importo < 0)) {
            throw new \InvalidArgumentException('invalid value for $importo when calling PendenzaArchivio., must be bigger than or equal to 0.');
        }
    ...
    public function setNumeroAvviso($numero_avviso)
    {
        ...
        if ((!preg_match("/^[0-9]{18}$/", ObjectSerializer::toString($numero_avviso)))) {
            throw new \InvalidArgumentException("invalid value for \$numero_avviso when calling PendenzaArchivio., must conform to the pattern /^[0-9]{18}$/.");
        }
    ...
    public function setDirezione($direzione)
    {
        ...
        if ((mb_strlen($direzione) > 35)) {
            throw new \InvalidArgumentException('invalid length for $direzione when calling PendenzaArchivio., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($direzione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $direzione when calling PendenzaArchivio., must be bigger than or equal to 1.');
        }
    ...
    public function setDivisione($divisione)
    {
        ...
        if ((mb_strlen($divisione) > 35)) {
            throw new \InvalidArgumentException('invalid length for $divisione when calling PendenzaArchivio., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($divisione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $divisione when calling PendenzaArchivio., must be bigger than or equal to 1.');
        }
    ...
    public function setVoci($voci)
    {
        ...
        if ((count($voci) > 5)) {
            throw new \InvalidArgumentException('invalid value for $voci when calling PendenzaArchivio., number of items must be less than or equal to 5.');
        }
        if ((count($voci) < 1)) {
            throw new \InvalidArgumentException('invalid length for $voci when calling PendenzaArchivio., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets stato
     *
     * @return \GovPay\Pagamenti\Model\StatoPendenza
     */
     ...
     * Sets stato
     *
     * @param \GovPay\Pagamenti\Model\StatoPendenza $stato stato
     *
     * @return self
     */
     ...
     *
     * @param string|null $descrizione_stato Descrizione in dettaglio dello stato della pendenza.
     *
     * @return self
     */
