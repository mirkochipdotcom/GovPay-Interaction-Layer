    ...
    */
    ...
    public function setCodiceTassonomicoPagoPa($codice_tassonomico_pago_pa)
    {
        ...
        if ((mb_strlen($codice_tassonomico_pago_pa) > 140)) {
            throw new \InvalidArgumentException('invalid length for $codice_tassonomico_pago_pa when calling TipoRiferimentoVocePendenza., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($codice_tassonomico_pago_pa) < 1)) {
            throw new \InvalidArgumentException('invalid length for $codice_tassonomico_pago_pa when calling TipoRiferimentoVocePendenza., must be bigger than or equal to 1.');
        }
