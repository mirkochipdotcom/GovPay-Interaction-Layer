 ...
 */
class RicevutaRpt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ricevuta_rpt';
    ...
    public const TIPO_CT_RICHIESTA_PAGAMENTO_TELEMATICO = 'ctRichiestaPagamentoTelematico';
    public const TIPO_CT_PAYMENT_PA = 'ctPaymentPA';
    ...
    {
        return [
            self::TIPO_CT_RICHIESTA_PAGAMENTO_TELEMATICO,
            self::TIPO_CT_PAYMENT_PA,
        ];
    }
    ...
    */
     ...
     * Sets tipo
     *
     * @param string $tipo Tipo XML della richiesta
     *
     * @return self
     */
     ...
     * Sets xml
     *
     * @param string $xml Richiesta in formato XML originale codificata in base64
     *
     * @return self
     */
     ...
     * Sets json
     *
     * @param object $json Richiesta in formato JSON
     *
     * @return self
     */
