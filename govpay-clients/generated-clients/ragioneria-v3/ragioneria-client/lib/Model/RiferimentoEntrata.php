...
/**
 * RiferimentoEntrata Class Doc Comment
 *
 * @category Class
 ...
 */
class RiferimentoEntrata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiferimentoEntrata';
    ...
    */
    ...
    public function setCodEntrata($cod_entrata)
    {
        ...
        if ((!preg_match("/(^[a-zA-Z0-9\\-_\\.]{1,35}$)/", ObjectSerializer::toString($cod_entrata)))) {
            throw new \InvalidArgumentException("invalid value for \$cod_entrata when calling RiferimentoEntrata., must conform to the pattern /(^[a-zA-Z0-9\\-_\\.]{1,35}$)/.");
        }
