...
class Pendenza implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'unita_operativa' => '\GovPay\Ragioneria\Model\UnitaOperativa',
        'causale' => 'string',
        'soggetto_pagatore' => '\GovPay\Ragioneria\Model\Soggetto',
        'importo' => 'float',
        ...
        'direzione' => 'string',
        'divisione' => 'string',
        'documento' => '\GovPay\Ragioneria\Model\Documento',
        'uuid' => 'string',
        'proprieta' => '\GovPay\Ragioneria\Model\ProprietaPendenza',
        'allegati' => '\GovPay\Ragioneria\Model\AllegatoPendenza[]'
    ];
    ...
    */
    ...
    public function setIdA2A($id_a2_a)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_a2_a)))) {
            throw new \InvalidArgumentException("invalid value for \$id_a2_a when calling Pendenza., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
    ...
    public function setIdPendenza($id_pendenza)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_pendenza when calling Pendenza., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
    ...
    public function setIdTipoPendenza($id_tipo_pendenza)
    {
        ...
        if ((!preg_match("/^([\\w\\-\\.]){1,35}$/", ObjectSerializer::toString($id_tipo_pendenza)))) {
            throw new \InvalidArgumentException("invalid value for \$id_tipo_pendenza when calling Pendenza., must conform to the pattern /^([\\w\\-\\.]){1,35}$/.");
        }
     ...
     *
     * @return \GovPay\Ragioneria\Model\UnitaOperativa|null
     */
     ...
     *
     * @param \GovPay\Ragioneria\Model\UnitaOperativa|null $unita_operativa unita_operativa
     *
     * @return self
     */
     ...
     *
     * @param \GovPay\Ragioneria\Model\Soggetto|null $soggetto_pagatore soggetto_pagatore
     *
     * @return self
     */
     ...
     * Gets documento
     *
     * @return \GovPay\Ragioneria\Model\Documento|null
     */
     ...
     * Sets documento
     *
     * @param \GovPay\Ragioneria\Model\Documento|null $documento documento
     *
     * @return self
     */
     ...
     * Gets proprieta
     *
     * @return \GovPay\Ragioneria\Model\ProprietaPendenza|null
     */
     ...
     * Sets proprieta
     *
     * @param \GovPay\Ragioneria\Model\ProprietaPendenza|null $proprieta proprieta
     *
     * @return self
     */
     ...
     * Gets allegati
     *
     * @return \GovPay\Ragioneria\Model\AllegatoPendenza[]|null
     */
     ...
     * Sets allegati
     *
     * @param \GovPay\Ragioneria\Model\AllegatoPendenza[]|null $allegati allegati
     *
     * @return self
     */
