...
/**
 * VocePendenzaPagata Class Doc Comment
 *
 * @category Class
 * @package  GovPay\Ragioneria
 * @author   OpenAPI Generator team
 ...
 */
class VocePendenzaPagata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VocePendenzaPagata';
    ...
    protected static $openAPITypes = [
        ...
        'contabilita' => '\GovPay\Ragioneria\Model\Contabilita',
        'metadata' => '\GovPay\Ragioneria\Model\Metadata',
        'pendenza' => '\GovPay\Ragioneria\Model\Pendenza',
        'riscossione' => '\GovPay\Ragioneria\Model\RiscossioneVocePagata'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('riscossione', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['descrizione']) && (mb_strlen($this->container['descrizione']) > 140)) {
        ...
        if ($this->container['riscossione'] === null) {
            $invalidProperties[] = "'riscossione' can't be null";
        }
    ...
    public function setCodEntrata($cod_entrata)
    {
        ...
        if ((!preg_match("/(^[a-zA-Z0-9\\-_\\.]{1,35}$)/", ObjectSerializer::toString($cod_entrata)))) {
            throw new \InvalidArgumentException("invalid value for \$cod_entrata when calling VocePendenzaPagata., must conform to the pattern /(^[a-zA-Z0-9\\-_\\.]{1,35}$)/.");
        }
    ...
    public function setIbanAccredito($iban_accredito)
    {
        ...
        if ((!preg_match("/[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/", ObjectSerializer::toString($iban_accredito)))) {
            throw new \InvalidArgumentException("invalid value for \$iban_accredito when calling VocePendenzaPagata., must conform to the pattern /[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/.");
        }
    ...
    public function setIbanAppoggio($iban_appoggio)
    {
        ...
        if ((!preg_match("/[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/", ObjectSerializer::toString($iban_appoggio)))) {
            throw new \InvalidArgumentException("invalid value for \$iban_appoggio when calling VocePendenzaPagata., must conform to the pattern /[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/.");
        }
    ...
    public function setCodiceTassonomicoPagoPa($codice_tassonomico_pago_pa)
    {
        ...
        if ((mb_strlen($codice_tassonomico_pago_pa) > 140)) {
            throw new \InvalidArgumentException('invalid length for $codice_tassonomico_pago_pa when calling VocePendenzaPagata., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($codice_tassonomico_pago_pa) < 1)) {
            throw new \InvalidArgumentException('invalid length for $codice_tassonomico_pago_pa when calling VocePendenzaPagata., must be bigger than or equal to 1.');
        }
    ...
    public function setHashDocumento($hash_documento)
    {
        ...
        if ((mb_strlen($hash_documento) > 70)) {
            throw new \InvalidArgumentException('invalid length for $hash_documento when calling VocePendenzaPagata., must be smaller than or equal to 70.');
        }
    ...
    public function setProvinciaResidenza($provincia_residenza)
    {
        ...
        if ((!preg_match("/[A-Z]{2,2}/", ObjectSerializer::toString($provincia_residenza)))) {
            throw new \InvalidArgumentException("invalid value for \$provincia_residenza when calling VocePendenzaPagata., must conform to the pattern /[A-Z]{2,2}/.");
        }
     ...
     * Sets descrizione
     *
     * @param string|null $descrizione descrizione della voce di pagamento
     *
     * @return self
     */
    public function setDescrizione($descrizione)
    {
        ...
        if ((mb_strlen($descrizione) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descrizione when calling VocePendenzaPagata., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($descrizione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descrizione when calling VocePendenzaPagata., must be bigger than or equal to 1.');
        }
    ...
    public function setDescrizioneCausaleRpt($descrizione_causale_rpt)
    {
        ...
        if ((mb_strlen($descrizione_causale_rpt) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descrizione_causale_rpt when calling VocePendenzaPagata., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($descrizione_causale_rpt) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descrizione_causale_rpt when calling VocePendenzaPagata., must be bigger than or equal to 1.');
        }
     ...
     * Gets contabilita
     *
     * @return \GovPay\Ragioneria\Model\Contabilita|null
     */
     ...
     * Sets contabilita
     *
     * @param \GovPay\Ragioneria\Model\Contabilita|null $contabilita contabilita
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \GovPay\Ragioneria\Model\Metadata|null
     */
     ...
     * Sets metadata
     *
     * @param \GovPay\Ragioneria\Model\Metadata|null $metadata metadata
     *
     * @return self
     */
     ...
     * Gets pendenza
     *
     * @return \GovPay\Ragioneria\Model\Pendenza
     */
     ...
     * Sets pendenza
     *
     * @param \GovPay\Ragioneria\Model\Pendenza $pendenza pendenza
     *
     * @return self
     */
     ...
     * Gets riscossione
     *
     * @return \GovPay\Ragioneria\Model\RiscossioneVocePagata
     */
    public function getRiscossione()
    {
        return $this->container['riscossione'];
    }

    /**
     * Sets riscossione
     *
     * @param \GovPay\Ragioneria\Model\RiscossioneVocePagata $riscossione riscossione
     *
     * @return self
     */
    public function setRiscossione($riscossione)
    {
        if (is_null($riscossione)) {
            throw new \InvalidArgumentException('non-nullable riscossione cannot be null');
        }
        $this->container['riscossione'] = $riscossione;
