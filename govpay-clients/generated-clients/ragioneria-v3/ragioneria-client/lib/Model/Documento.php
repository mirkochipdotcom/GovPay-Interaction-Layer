 ...
 */
class Documento implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Documento';
    ...
    protected static $openAPITypes = [
        'rata' => 'float',
        'soglia' => '\GovPay\Ragioneria\Model\VincoloPagamento',
    ...
    */
     ...
     * Sets rata
     *
     * @param float $rata Rata del documento
     *
     * @return self
     */
    public function setRata($rata)
    {
        ...
        if (($rata < 1)) {
            throw new \InvalidArgumentException('invalid value for $rata when calling Documento., must be bigger than or equal to 1.');
        }
     ...
     * Gets soglia
     *
     * @return \GovPay\Ragioneria\Model\VincoloPagamento
     */
     ...
     * Sets soglia
     *
     * @param \GovPay\Ragioneria\Model\VincoloPagamento $soglia soglia
     *
     * @return self
     */
    ...
    public function setIdentificativo($identificativo)
    {
        ...
        if ((mb_strlen($identificativo) > 35)) {
            throw new \InvalidArgumentException('invalid length for $identificativo when calling Documento., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($identificativo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identificativo when calling Documento., must be bigger than or equal to 1.');
        }
    ...
    public function setDescrizione($descrizione)
    {
        ...
        if ((mb_strlen($descrizione) > 80)) {
            throw new \InvalidArgumentException('invalid length for $descrizione when calling Documento., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($descrizione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descrizione when calling Documento., must be bigger than or equal to 1.');
        }
