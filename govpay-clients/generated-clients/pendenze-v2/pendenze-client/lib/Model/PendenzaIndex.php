    ...
    */
    ...
    public function setCausale($causale)
    {
        ...
        if ((mb_strlen($causale) > 140)) {
            throw new \InvalidArgumentException('invalid length for $causale when calling PendenzaIndex., must be smaller than or equal to 140.');
        }
    ...
    public function setImporto($importo)
    {
        ...
        if (($importo > 10000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $importo when calling PendenzaIndex., must be smaller than or equal to 10000000000000000.');
        }
        if (($importo < 0)) {
            throw new \InvalidArgumentException('invalid value for $importo when calling PendenzaIndex., must be bigger than or equal to 0.');
        }
    ...
    public function setNumeroAvviso($numero_avviso)
    {
        ...
        if ((!preg_match("/^[0-9]{18}$/", ObjectSerializer::toString($numero_avviso)))) {
            throw new \InvalidArgumentException("invalid value for \$numero_avviso when calling PendenzaIndex., must conform to the pattern /^[0-9]{18}$/.");
        }
    ...
    public function setDirezione($direzione)
    {
        ...
        if ((mb_strlen($direzione) > 35)) {
            throw new \InvalidArgumentException('invalid length for $direzione when calling PendenzaIndex., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($direzione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $direzione when calling PendenzaIndex., must be bigger than or equal to 1.');
        }
    ...
    public function setDivisione($divisione)
    {
        ...
        if ((mb_strlen($divisione) > 35)) {
            throw new \InvalidArgumentException('invalid length for $divisione when calling PendenzaIndex., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($divisione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $divisione when calling PendenzaIndex., must be bigger than or equal to 1.');
        }
