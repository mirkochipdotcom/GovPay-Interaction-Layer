...
class Soggetto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'tipo' => '\GovPay\Pendenze\Model\TipoSoggetto',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['identificativo']) > 16)) {
            $invalidProperties[] = "invalid value for 'identificativo', the character length must be smaller than or equal to 16.";
        }

        if ((mb_strlen($this->container['identificativo']) < 2)) {
            $invalidProperties[] = "invalid value for 'identificativo', the character length must be bigger than or equal to 2.";
        }
     ...
     * Gets tipo
     *
     * @return \GovPay\Pendenze\Model\TipoSoggetto
     */
     ...
     * Sets tipo
     *
     * @param \GovPay\Pendenze\Model\TipoSoggetto $tipo tipo
     *
     * @return self
     */
    ...
    public function setIdentificativo($identificativo)
    {
        ...
        if ((mb_strlen($identificativo) > 16)) {
            throw new \InvalidArgumentException('invalid length for $identificativo when calling Soggetto., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($identificativo) < 2)) {
            throw new \InvalidArgumentException('invalid length for $identificativo when calling Soggetto., must be bigger than or equal to 2.');
        }
