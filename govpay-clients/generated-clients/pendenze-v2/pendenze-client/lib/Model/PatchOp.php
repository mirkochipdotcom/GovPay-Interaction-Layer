 ...
 */
class PatchOp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOp';
    ...
    */
     ...
     * Sets op
     *
     * @param string $op Operazione da eseguire
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string $path path dell'oggetto dell'operazione
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param object $value valore del'oggetto dell'operazione
     *
     * @return self
     */
