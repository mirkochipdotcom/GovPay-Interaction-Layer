...
class NuovaVocePendenza implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id_dominio']) && (mb_strlen($this->container['id_dominio']) > 35)) {
            $invalidProperties[] = "invalid value for 'id_dominio', the character length must be smaller than or equal to 35.";
        }

        if (!is_null($this->container['id_dominio']) && (mb_strlen($this->container['id_dominio']) < 1)) {
            $invalidProperties[] = "invalid value for 'id_dominio', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['id_dominio']) && !preg_match("/(^[0-9]{11}$)/", $this->container['id_dominio'])) {
    ...
    public function setIbanAccredito($iban_accredito)
    {
        ...
        if ((!preg_match("/[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/", ObjectSerializer::toString($iban_accredito)))) {
            throw new \InvalidArgumentException("invalid value for \$iban_accredito when calling NuovaVocePendenza., must conform to the pattern /[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/.");
        }
    ...
    public function setIbanAppoggio($iban_appoggio)
    {
        ...
        if ((!preg_match("/[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/", ObjectSerializer::toString($iban_appoggio)))) {
            throw new \InvalidArgumentException("invalid value for \$iban_appoggio when calling NuovaVocePendenza., must conform to the pattern /[a-zA-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}/.");
        }
    ...
    public function setCodiceContabilita($codice_contabilita)
    {
        ...
        if ((mb_strlen($codice_contabilita) > 135)) {
            throw new \InvalidArgumentException('invalid length for $codice_contabilita when calling NuovaVocePendenza., must be smaller than or equal to 135.');
        }
        if ((mb_strlen($codice_contabilita) < 1)) {
            throw new \InvalidArgumentException('invalid length for $codice_contabilita when calling NuovaVocePendenza., must be bigger than or equal to 1.');
        }
    ...
    public function setHashDocumento($hash_documento)
    {
        ...
        if ((mb_strlen($hash_documento) > 70)) {
            throw new \InvalidArgumentException('invalid length for $hash_documento when calling NuovaVocePendenza., must be smaller than or equal to 70.');
        }
    ...
    public function setProvinciaResidenza($provincia_residenza)
    {
        ...
        if ((!preg_match("/[A-Z]{2,2}/", ObjectSerializer::toString($provincia_residenza)))) {
            throw new \InvalidArgumentException("invalid value for \$provincia_residenza when calling NuovaVocePendenza., must conform to the pattern /[A-Z]{2,2}/.");
        }
    ...
    public function setIdVocePendenza($id_voce_pendenza)
    {
        ...
        if ((mb_strlen($id_voce_pendenza) > 35)) {
            throw new \InvalidArgumentException('invalid length for $id_voce_pendenza when calling NuovaVocePendenza., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($id_voce_pendenza) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_voce_pendenza when calling NuovaVocePendenza., must be bigger than or equal to 1.');
        }
    ...
    public function setImporto($importo)
    {
        ...
        if (($importo > 10000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $importo when calling NuovaVocePendenza., must be smaller than or equal to 10000000000000000.');
        }
        if (($importo < 0)) {
            throw new \InvalidArgumentException('invalid value for $importo when calling NuovaVocePendenza., must be bigger than or equal to 0.');
        }
    ...
    public function setDescrizione($descrizione)
    {
        ...
        if ((mb_strlen($descrizione) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descrizione when calling NuovaVocePendenza., must be smaller than or equal to 140.');
        }
        if ((mb_strlen($descrizione) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descrizione when calling NuovaVocePendenza., must be bigger than or equal to 1.');
        }
    ...
    public function setDescrizioneCausaleRpt($descrizione_causale_rpt)
    {
        ...
        if ((mb_strlen($descrizione_causale_rpt) < 1)) {
            throw new \InvalidArgumentException('invalid length for $descrizione_causale_rpt when calling NuovaVocePendenza., must be bigger than or equal to 1.');
        }
    ...
    public function setIdDominio($id_dominio)
    {
        ...
        if ((mb_strlen($id_dominio) > 35)) {
            throw new \InvalidArgumentException('invalid length for $id_dominio when calling NuovaVocePendenza., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($id_dominio) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_dominio when calling NuovaVocePendenza., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/(^[0-9]{11}$)/", ObjectSerializer::toString($id_dominio)))) {
            throw new \InvalidArgumentException("invalid value for \$id_dominio when calling NuovaVocePendenza., must conform to the pattern /(^[0-9]{11}$)/.");
        }
